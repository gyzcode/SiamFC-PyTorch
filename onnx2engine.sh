...
trtexec --onnx=pretrained/siamfc_alexnet_pruning_e50_x.onnx --workspace=1024 --fp16 --int8 --calib=pretrained/CalibrationTableSiamfc_pruning --saveEngine=pretrained/siamfc_alexnet_pruning_e50_x_int8.engine